...
def main():
    method = 'psl'
    # in results/weightlearning/{}/noisy_attribute_fairness_threshold_study write
    ...
    path = '{}/../results/fairness/{}/noisy_attribute_fairness_threshold_study'.format(dirname, method)
    ...
    for dataset in datasets:
        ...
        for wl_method in wl_methods:
            ...
            path = '{}/../results/fairness/{}/noisy_attribute_fairness_threshold_study/{}/{}'.format(dirname, method, dataset, wl_method)
    ...
    performance_frame.to_csv(
        '{}/../results/fairness/{}/noisy_attribute_fairness_threshold_study/study_results.csv'.format(dirname, method, method),
        index=False)
